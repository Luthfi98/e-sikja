...
<table width="100%" border="0" style="margin-top: 10px;">
    ...
    <tr>
        <td style="text-align: justify; line-height: 1.5;" colspan="3">
          Bahwa kedua nama tersebut pasangan suami istri yang telah bercerai dari tahun {{ $data->divorce_year }}.
            <br>
            <br>
...
<table style="float: right; margin-top: 10px;" border="0">
    ...
    <tr>
        <td width="60%" style="text-align: center; padding-top: 100px;">
            ...
            <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('setting/'.$setting['cap_lurah']))) }}" class="logo" style="position: absolute; top: 45rem; left: 25rem; width: 250px; height: auto;">
                
            @endif
            @if ($setting['ttd_lurah'])
                
            <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('setting/'.$setting['ttd_lurah']))) }}" class="logo" style="position: absolute; top: 44rem; left: 28rem; width: 200px; height: auto;">
            @endif
        </td>
