                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col">
                                    <div class="text-xxs font-weight-bold text-primary text-uppercase mb-1">
                                        Total Pengaduan</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $totalPengaduan ?? 0 }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col">
                                    <div class="text-xxs font-weight-bold text-warning text-uppercase mb-1">
                                        Sedang Diproses</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $pengaduanDiproses ?? 0 }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col">
                                    <div class="text-xxs font-weight-bold text-success text-uppercase mb-1">
                                        Selesai</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $pengaduanSelesai ?? 0 }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col">
                                    <div class="text-xxs font-weight-bold text-danger text-uppercase mb-1">
                                        Ditolak</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $pengaduanDitolak ?? 0 }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body p-2">
                            <div class="row no-gutters align-items-center">
                                <div class="col">
                                    <div class="text-xxs font-weight-bold text-warning text-uppercase mb-1">
                                        Sedang Diproses</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $pengajuanDiproses ?? 0 }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body p-2">
                            <div class="row no-gutters align-items-center">
                                <div class="col">
                                    <div class="text-xxs font-weight-bold text-success text-uppercase mb-1">
                                        Selesai</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $pengajuanSelesai ?? 0 }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body p-2">
                            <div class="row no-gutters align-items-center">
                                <div class="col">
                                    <div class="text-xxs font-weight-bold text-danger text-uppercase mb-1">
                                        Ditolak</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $pengajuanDitolak ?? 0 }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-lg-4">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Cek Status Pengajuan</h6>
                </div>
                <div class="card-body">
                    ...
                    {{-- <div class="mt-4">
                        ...
                        <ul class="list-unstyled">
                            <li class="mb-2">
                                ...
                                Status pengajuan akan diperbarui secara real-time
                            </li>
                            <li class="mb-2">
                                <i class="fas fa-clock text-warning"></i>
                                Proses pengajuan membutuhkan waktu 1-3 hari kerja
                            </li>
                            <li>
                                <i class="fas fa-phone text-success"></i>
                                Hubungi admin untuk bantuan: (021) 1234567
                            </li>
                        </ul>
                    </div> --}}
                </div>
